...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/style/dashboard-style.css?v=1.2">
    ...
    <div class="dashboard-container">
        <nav class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li><a href="mark-attendance.jsp" class="active"><i class='bx bxs-calendar-check'></i> Attendance</a></li>
