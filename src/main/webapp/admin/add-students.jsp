...
<link rel="stylesheet" href="<%=request.getContextPath()%>/style/form-style.css">
	...
	<div class="dashboard-container">
		...
		<main class="main-content">
			<header>
				...
				<a href="students.jsp" class="btn-back"><i
				...
				<div class="form-card">
					...
					<form action="<%=request.getContextPath() %>/AddStudentServlet" method="post">
						<div class="form-grid">
							...
							<div class="input-group">
								<label>Department / Course</label> <select name="department">
							...
							<div class="input-group">
								<label>Current Semester</label> <input type="text" name="sem"
									placeholder="" pattern="\d" maxlength="1">
							</div>
							<div class="input-group">
