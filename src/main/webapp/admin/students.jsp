    ...
    <div class="dashboard-container">
        <nav class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li><a href="<%=request.getContextPath() %>/admin/students.jsp" class="active"><i class='bx bxs-user-detail'></i> Students</a></li>
        ...
        <main class="main-content">
            ...
            <section class="search-action-container">
                ...
                <a href="<%=request.getContextPath() %>/admin/add-students.jsp" class="btn-add-main">
