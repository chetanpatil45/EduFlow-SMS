...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/style/form-style.css"> <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>
</head>
<body>
    <div class="dashboard-container">
        <nav class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li><a href="<%=request.getContextPath() %>/admin/setting.jsp" class="active"><i class='bx bxs-cog'></i> Settings</a></li>
